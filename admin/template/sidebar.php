...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        <div class="sidebar-brand-icon ">
            <img src="assets/img/pic/p.jpg" width="37px" alt="">
        </div>
        <div class="sidebar-brand-text mx-3">Stock Beras<sup></sup></div>
    </a>
    ...
    <?php if($_SESSION['role'] == 'admin'): ?>
        ...
        <li class="nav-item active">
            ...
            <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="index.php?page=EOQ">Analisis EOQ</a>
        ...
        <!-- Menu Transaksi (Admin juga bisa akses) -->
        <li class="nav-item active">
    ...
    <?php elseif($_SESSION['role'] == 'pegawai'): ?>
        <!-- Menu untuk kasir hanya Transaksi -->
        <li class="nav-item active">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapse3" aria-expanded="true"
                aria-controls="collapse3">
                <i class="fas fa-fw fa-desktop"></i>
            ...
            <div id="collapse3" class="collapse" aria-labelledby="heading3" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <a class="collapse-item" href="index.php?page=pesan">Pesan</a>
                    <a class="collapse-item" href="index.php?page=konfirmasi">Konfirmasi Pesanan</a>
                    <a class="collapse-item" href="index.php?page=jual">Transaksi Jual</a>
                    <a class="collapse-item" href="index.php?page=laporan">Laporan Penjualan</a>
                </div>
            </div>
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item" href="index.php?page=detail">
